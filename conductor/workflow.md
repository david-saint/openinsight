...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    - **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `CI=true npm test -- run`"
...
```bash
# Start Vite dev server with HMR (builds extension to dist/)
npm run dev

# Run unit tests (Vitest)
CI=true npm test -- run

# Run e2e tests (Playwright - requires built extension)
